...
public class EmployeeTest {
	...
	public void setUp() throws Exception {
		...
		employee = new Employee("Name", "Surname", "Address", 2100f, office, new GenericHandler("1234"));
		employeeWithoutOffice = new Employee("Name", "Surname", "Address", 2100f, new GenericHandler("1234"));
	}
	...
	public void testGetOffice() {
		...
		assertEquals(0, employee.getOffice().getIdOffice().compareTo(office.getIdOffice()), 0);
		employee.setOffice(office2);
		assertEquals(0, employee.getOffice().getIdOffice().compareTo(office2.getIdOffice()), 0);
	}
