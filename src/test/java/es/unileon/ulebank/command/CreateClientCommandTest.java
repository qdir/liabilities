...
public class CreateClientCommandTest {
	...
	public void setUp() throws MalformedHandlerException {
		...
		createClientCommand = new CreateClientCommand(office, "Name",
				"Surnames", address, "Civil State", 999999999, 999999999,
	...
	//
	// createClientCommand = new CreateClientCommand(office, "Name", "Surnames",
	// address, "Civil State", 999999999, 999999999, "Profession", new Date(),
	// 'X', 7155252, 'J', new GenericHandler("2345"));
	// }
