...
public class TimeUtilsTest {
    ...
    public void testGetYear() {
        ...
        assertEquals(TimeUtils.getYear(new Date(24l * 60l * 60l * 1000l * 370l)), 1971);
    }

    @Test
    public void testGetDay() {
        assertEquals(TimeUtils.getDay(new Date(0)), 1);
        assertEquals(TimeUtils.getDay(new Date(24l * 60l * 60l * 1000l + 10)), 2);
    }

    @Test
    public void testGetMonth() {
        assertEquals(TimeUtils.getMonth(new Date(0)), 1);
        assertEquals(TimeUtils.getMonth(new Date(24l * 60l * 60l * 1000l*32)), 2);
    }
