...
public class IteratorBetweenTwoAmountsTest {
    ...
    public void setup() throws WrongArgsException {
        ...
        this.iteratorFromIterator = new IteratorBetweenTwoAmounts<>(this.elements.iterator(), this.min, this.max);
        this.iteratorFromList = new IteratorBetweenTwoAmounts<>(this.elements, this.min, this.max);
    }
    ...
    public void testWrongArgumentsFromList() throws WrongArgsException {
        new IteratorBetweenTwoAmounts<>(this.elements, 100, 0);
    }

    @Test(expected = WrongArgsException.class)
    public void testWrongArgumentsFromIterator() throws WrongArgsException {
        new IteratorBetweenTwoAmounts<>(this.elements.iterator(), 100, 0);
    }
