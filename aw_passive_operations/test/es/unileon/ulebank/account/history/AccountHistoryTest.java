...
public class AccountHistoryTest {
	...
	Date date1 = sdf.parse("01/01/2014");
        ...
        Transaction transaction1 = new GenericTransaction(new GenericHandler("1234"), 10.5d, date1, date1, "Imposicion", TransactionType.CHARGE);
        Transaction transaction2 = new GenericTransaction(new GenericHandler("1234"), 10.5d, date2, date2, "Imposicion", TransactionType.CHARGE);
        Transaction transaction3 = new GenericTransaction(new GenericHandler("1234"), 10.5d, date3, date3, "Imposicion", TransactionType.CHARGE);
