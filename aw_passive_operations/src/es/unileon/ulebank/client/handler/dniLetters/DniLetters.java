...
public class DniLetters {
    ...
    /**
     * Gets the unique instance of the class, if it doesn't exists, the instance is created
     * @return instance
     */
    ...
    /**
     * Obtaint the dni correct letter and compare it with the parametter dniLetter
     * @param dniNumber
     * @param dniLetter
